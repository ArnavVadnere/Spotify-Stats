  ...
  return (
    ...
    <div class="App">
      ...
      <body class="App-body">
        ...
        <div >
          {!token && (
            <button id="button"><i class="fa fa-spotify"></i>
              <a
